...
//		Entity entity = new Entity(dragon, new Vector3f(0, 0, -20), 0, 0, 0, 1);
		...
		Entity stall = new Entity(stallModel, new Vector3f(0,0,-50),0,0,0, 0.4f);
		...
		Player player = new Player(person, new Vector3f(0, 0, -10), 0, 0, 0, 1);
		...
		{
			entities.add(new Entity(grassModel, new Vector3f(random.nextFloat() * 100 - 50, 0, random.nextFloat() * 800 - 400), 0, 0, 0, 0.4f));
			entities.add(new Entity(grassModel, new Vector3f(random.nextFloat() * 100 - 50, 0, random.nextFloat() * 800 - 400), 0, 0, 0, 0.4f));
			entities.add(new Entity(fernModel, new Vector3f(random.nextFloat() * 100 - 50, 0, random.nextFloat() * 800 - 400), 0, 0, 0, 0.2f));
			entities.add(new Entity(treeModel, new Vector3f(random.nextFloat() * 100 - 50, 0, random.nextFloat() * 800 - 400), 0, 0, 0, 1.3f));
		}
